...
@Component({
  selector: 'app-award-winning-books',
  templateUrl: './award-winning-books.component.html',
  styleUrls: ['./award-winning-books.component.css']
})
export class AwardWinningBooksComponent {
  bestSellingBooks = [
